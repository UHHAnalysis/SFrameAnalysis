...
class CMSTopTagOverlapSelection: public SelectionModule {
 public:
  CMSTopTagOverlapSelection(double delR_Lep_TopTag = 0.8 , double delR_Jet_TopTag = 1.3);
...
class CMSTopTagAntiktJetSelection : public SelectionModule{
 public:
  CMSTopTagAntiktJetSelection(unsigned int min_TopTag, unsigned int min_Jets, double min_distance,unsigned int max_TopTag=int_infinity(),unsigned int max_Jets=int_infinity());
...
public:
    NCMSTopTagSelection(int min_ntoptag, int max_ntoptag=int_infinity());
    ~NCMSTopTagSelection() {};
