  ...
  for(unsigned int i=0; i< bcc->taus->size(); ++i)
    {
      ...
      Hist("againstElectronLooseMVA3") -> Fill(tau.againstElectronLooseMVA5(), weight);
      Hist("againstElectronMediumMVA3") -> Fill(tau.againstElectronMediumMVA5(), weight);
      Hist("againstElectronTightMVA3") -> Fill(tau.againstElectronTightMVA5(), weight);
      Hist("againstElectronVTightMVA3") -> Fill(tau.againstElectronVTightMVA5(), weight);
    ...
    if (bcc->taus->size() > 0)
    {
      ...
      Hist("againstElectronLooseMVA3_1") -> Fill(tau.againstElectronLooseMVA5(), weight);
      Hist("againstElectronMediumMVA3_1") -> Fill(tau.againstElectronMediumMVA5(), weight);
      Hist("againstElectronTightMVA3_1") -> Fill(tau.againstElectronTightMVA5(), weight);
      Hist("againstElectronVTightMVA3_1") -> Fill(tau.againstElectronVTightMVA5(), weight);
      ...
      if (bcc->taus->size() > 1 )
	{
	  ...
	  Hist("againstElectronLooseMVA3_2") -> Fill(tau.againstElectronLooseMVA5(), weight);
	  Hist("againstElectronMediumMVA3_2") -> Fill(tau.againstElectronMediumMVA5(), weight);
	  Hist("againstElectronTightMVA3_2") -> Fill(tau.againstElectronTightMVA5(), weight);
	  Hist("againstElectronVTightMVA3_2") -> Fill(tau.againstElectronVTightMVA5(), weight);
